...
export default function MutasiPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess("Permohonan mutasi berhasil disubmit!")
  ...
  return (
    <DashboardLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Surat Rekomendasi Mutasi</h1>
          <p className="text-gray-600">Mutasi ke Kabupaten Kudus - Kendaraan Angkutan Penumpang/Barang Umum</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Informasi lengkap pemohon mutasi</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="companyName"
                  name="companyName"
                  placeholder="Koperasi Trans Muria Utama"
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Data kendaraan yang akan dimutasi</CardDescription>
            </CardHeader>
          ...
          <div className="flex gap-4 pt-4">
            <Button type="submit" disabled={loading} className="flex-1">
              {loading ? "Menyimpan..." : "Submit Permohonan Mutasi"}
            </Button>
