...
export default function KendaraanBaruPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess("Permohonan kendaraan baru berhasil disubmit!")
  ...
  return (
    <DashboardLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Permohonan Kendaraan Baru</h1>
          <p className="text-gray-600">Permohonan registrasi kendaraan angkutan penumpang/barang umum baru</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Informasi lengkap pemohon registrasi kendaraan baru</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="companyName"
                  name="companyName"
                  placeholder="Nama perusahaan angkutan"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="rounded"
                  />
                  <Label htmlFor="hasInvoice">Faktur Pembelian Kendaraan</Label>
                </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Data kendaraan baru yang akan didaftarkan</CardDescription>
            </CardHeader>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleVehicleChange(vehicle.id, "fuelType", e.target.value)}
                        required
                        disabled={loading}
                      />
                    </div>
          ...
          <div className="flex gap-4 pt-4">
            <Button type="submit" disabled={loading} className="flex-1">
              {loading ? "Menyimpan..." : "Submit Permohonan Kendaraan Baru"}
            </Button>
